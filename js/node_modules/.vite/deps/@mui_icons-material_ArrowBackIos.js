...
import { t as require_jsx_runtime } from "./jsx-runtime-B51Ramji.js";
...
var responsivePropType = import_prop_types$4.default.oneOfType([
	...
	function styleFunctionSx$1(props) {
		...
		function traverse(sxInput) {
			...
			Object.keys(sxObject).forEach((styleKey) => {
				...
				if (value !== null && value !== void 0) if (typeof value === "object") if (config[styleKey]) css = merge_default(css, getThemeValue(styleKey, value, theme, config));
				else {
					const breakpointsValues = handleBreakpoints({ theme }, value, (x) => ({ [styleKey]: x }));
					if (objectsHaveSameKeys(breakpointsValues, value)) css[styleKey] = styleFunctionSx$1({
						sx: value,
						theme,
						nested: true
					});
					else css = merge_default(css, breakpointsValues);
				}
				else css = merge_default(css, getThemeValue(styleKey, value, theme, config));
			});
...
(function(_jsx$5) {
	var JSX;
	(function(_JSX) {})(JSX || (JSX = _jsx$5.JSX || (_jsx$5.JSX = {})));
})(jsx || (jsx = {}));
...
//#endregion
//#region node_modules/@mui/icons-material/esm/ArrowBackIos.js
var ArrowBackIos_default = createSvgIcon(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M11.67 3.87 9.9 2.1 0 12l9.9 9.9 1.77-1.77L3.54 12z" }), "ArrowBackIos");

//#endregion
export { ArrowBackIos_default as default };
