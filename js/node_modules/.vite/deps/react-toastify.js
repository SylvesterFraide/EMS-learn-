...
import ut, { cloneElement, isValidElement, useEffect, useLayoutEffect, useRef, useState, useSyncExternalStore } from "react";
...
`);
var L = (t) => typeof t == "number" && !isNaN(t), N = (t) => typeof t == "string", P = (t) => typeof t == "function", mt = (t) => N(t) || L(t), B = (t) => N(t) || P(t) ? t : null, pt = (t, o) => t === !1 || L(t) && t > 0 ? t : o, z = (t) => isValidElement(t) || N(t) || P(t) || L(t);
...
function tt(t, o, e = !1) {
	return isValidElement(t) && !N(t.type) ? cloneElement(t, {
...
function yt({ closeToast: t, theme: o, ariaLabel: e = "close" }) {
	return ut.createElement("button", {
...
function gt({ delay: t, isRunning: o, closeToast: e, type: r$1 = "default", hide: s, className: l, controlledProgress: a, progress: d, rtl: c, isIn: T, theme: g }) {
	...
	return ut.createElement("div", {
		...
		"data-hidden": v
	}, ut.createElement("div", { className: `Toastify__progress-bar--bg Toastify__progress-bar-theme--${g} Toastify__progress-bar--${r$1}` }), ut.createElement("div", {
		role: "progressbar",
...
function It(t) {
	var a;
	let { subscribe: o, getSnapshot: e, setProps: r$1 } = useRef(Et(t)).current;
	r$1(t);
...
function At(t) {
	let [o, e] = useState(!1), [r$1, s] = useState(!1), l = useRef(null), a = useRef({
		start: 0,
		delta: 0,
		removalDistance: 0,
		canCloseOnClick: !0,
...
var G = ({ theme: t, type: o, isLoading: e, ...r$1 }) => ut.createElement("svg", {
	viewBox: "0 0 24 24",
	width: "100%",
	height: "100%",
...
function ao(t) {
	return ut.createElement(G, { ...t }, ut.createElement("path", { d: "M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z" }));
}
function so(t) {
	return ut.createElement(G, { ...t }, ut.createElement("path", { d: "M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z" }));
}
function no(t) {
	return ut.createElement(G, { ...t }, ut.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}
function ro(t) {
...
function Nt({ theme: t, type: o, isLoading: e, icon: r$1 }) {
	...
	return r$1 === !1 || (P(r$1) ? s = r$1({
		...l,
		isLoading: e
	}) : isValidElement(r$1) ? s = cloneElement(r$1, l) : e ? s = W.spinner() : lo(o) && (s = W[o](l))), s;
}
var wt = (t) => {
	...
	return a === !1 || (P(a) ? H = a(j) : isValidElement(a) ? H = cloneElement(a, j) : H = yt(j)), ut.createElement(C, {
		isIn: _,
		done: m,
		position: S,
	...
	}, ft != null && ut.createElement("div", { className: clsx_default("Toastify__toast-icon", { ["Toastify--animate-icon Toastify__zoom-enter"]: !k }) }, ft), tt(d, t, !o), H, !t.customProgressBar && ut.createElement(gt, {
		...b && !dt ? { key: `p-${b}` } : {},
		rtl: u,
		theme: A,
		delay: c,
...
function Lt(t) {
	let o = {
		..._o,
		...t
	}, e = t.stacked, [r$1, s] = useState(!0), l = useRef(null), { getToastToRender: a, isToastActive: d, count: c } = It(o), { className: T, style: g, rtl: v, containerId: x, hotKeys: C } = o;
	function S(f) {
	...
	return Ot(() => {
		...
		return ut.createElement("div", {
			...
			style: b,
			key: `c-${f}`
		}, p.map(({ content: i, props: n }) => ut.createElement(wt, {
			...n,
			stacked: e,
			collapseAll: E,
