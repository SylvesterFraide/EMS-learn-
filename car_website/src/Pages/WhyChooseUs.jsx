...
const WhyChooseUs = () => {
  return (
    <section className="w-[80vw] mx-auto bg-purple-100 h-screen">
      <h1 className="text-4xl text-purple-600 text-center font-bold mb-4">
        Why Choose Us?
      </h1>
      <div className="flex md:flex-row flex-col flex-wrap justify-evenly mt-10  ">
        <div className="bg-black text-center text-white w-110 px-6 py-6 rounded-md shadow-md">
          ...
          <p className="text-lg text-gray-300 mb-8">
            ...
            We ensure competitive pricing so you always drive away with more incredible
            savings.
          </p>
