    ...
    <>
      ...
      <div className="h-full w-[80vw] mx-auto my-12">
        <div className="flex gap-12 sm:gap-12 flex-col md:flex-row ">
          <div className="flex gap-3 md:flex-row flex-col bg-gray-100 p-4 rounded-md shadow-md h-[500px]">
            <div className="flex flex-row md:flex-col gap-2 overflow-x-scroll md:overflow-x-hidden overflow-y-scroll-hidden justify-between sm:justify-normal md:w-[18.7%] w-full ">
        ...
        <div className="mt-20">
          <h3 className="text-2xl font-bold my-8 text-center">
            Related Services
          </h3>
